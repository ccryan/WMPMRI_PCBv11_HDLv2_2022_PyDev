...
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil
    ...
    # pulse parameters
    plen_base = 6 # 4.40 # the precharging length base. Don't forget to set the corresponding p90_us
    ...
    scanspacing_us = 600000 # normally 100000 for doped water
    samples_per_echo = 500 # 1000, 600, 200, 100
    echoes_per_scan = 75# 280 for water, 400 for oil
    n_iterate = 4
    ...
    vvarac = -2.0 # -1.87 # set to -1.91V # more negative, more capacitance
    # precharging the vpc
    lcs_vpc_pchg_us = 25
    ...
    a_est = [3] # array of amplitude estimate for fitting
    t2_est = [16e-3] # array of t2 estimate for fitting
    en_fit = True
