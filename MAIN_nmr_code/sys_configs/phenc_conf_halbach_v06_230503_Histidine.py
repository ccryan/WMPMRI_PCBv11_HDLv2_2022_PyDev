...
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil
    ...
    # pulse parameters
    plen_base = 6.2# 4.40 # the precharging length base. Don't forget to set the corresponding p90_us
    ...
    p180_dtcl = p90_dtcl
    echoshift_us = 100
    echotime_us = 2000 # 400 or 70
    scanspacing_us = 1600000 # normally 100000 for doped water
    samples_per_echo = 3500 # 1000, 600, 200, 100
    ...
    vvarac = 1.12 # 1.15V@2.56MHz # more negative, more capacitance
    # precharging the vpc
    lcs_vpc_pchg_us = 45
    ...
    t2_est = [15e-3] # array of t2 estimate for fitting
    en_fit = True
