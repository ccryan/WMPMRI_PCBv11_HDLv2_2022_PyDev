class phenc_conf_halbach_v06_230503_test():
# this configuration is for:
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil

    # pulse parameters
    plen_base = 8# 4.40 # the precharging length base. Don't forget to set the corresponding p90_us
    refill_mult = 1.6#1.5 # the refill multiplication to compensate RF loss
    p180_p90_fact = 1.00 # 2.0 # multiplication factor between p90 to p180 length
    
    # cpmg settings
    cpmg_freq = 2.564  # 4.164 # in MHz
    bstrap_pchg_us = 2000
    lcs_pchg_us = 100
    lcs_dump_us = 100
    ...
    p180_dtcl = p90_dtcl
    echoshift_us = 50
    echotime_us = 1300 # 400 or 70
    scanspacing_us = 20000000 # normally 100000 for doped water
    samples_per_echo = 6000 # 1000, 600, 200, 100
    echoes_per_scan = 60 # 280 for water, 400 for oil
    n_iterate = 128
    ...
    vvarac = 1.6 # -2.3 @2.56MHz # more negative, more capacitance
    #-0.3
    # preamp v1 1.6
    # precharging the vpc
    lcs_vpc_pchg_us = 45
    ...
    a_est = [1] # array of amplitude estimate for fitting
    t2_est = [1000e-3] # array of t2 estimate for fitting
    en_fit = True
